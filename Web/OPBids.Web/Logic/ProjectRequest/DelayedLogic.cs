...
namespace OPBids.Web.Logic.ProjectRequest
{
    ...
    {
        #region Context
        public DelayedLogic(HttpRequestBase httpContext)
        {
        ...
        {
            return Constant.ProjectRequest.HeaderView.Delayed;
        }
        ...
        {            
            ...
            payload.projectSearch.project_status = "DELAYED";
            ...
            return PartialView(Constant.ProjectRequest.ResultView.Delayed, _result.value);
        }
