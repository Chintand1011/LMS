var PROJSTAT = {
    ...
    Initialize: function () {
        if ($("#headerTitle").length <= 0) {
            setTimeout(PROJSTAT.Initialize, 1000);
            return;
        }
        ...
        $(".toolbar-add").click(function (e) {
            ...
            PROJSTAT.Status = CONST.record_status.activate;
        ...
        $(".toolbar-delete").click(function () {
            var confirmEvt = function () {
                ...
                PROJSTAT.MaintainData(CONST.transaction_type.statusUpdate, 0, null, null, CONST.record_status.delete, _item_list);
            }
        ...
        $(".toolbar-search").click(function () {
            PROJSTAT.MaintainData(CONST.transaction_type.search, $("#u_id").val(), $("#u_code").val(), $("#u_description").val(), PROJSTAT.Status, null);
        });
        ...
        $("#btnSave").click(function () {
            if (Site.ValidateRequiredEntries("#saveModal", null) == true) {
                PROJSTAT.MaintainData(CONST.transaction_type.save, $("#u_id").val(), $("#u_code").val(), $("#u_description").val(), PROJSTAT.Status, null);
        ...
        $(".item-setting-edit").click(function (e) {
            ...
            PROJSTAT.Status = $(["tr#row-" + _id, " td[status]"].join('')).attr("statusid").trim();
            $('#saveModal').modal('show');
            $("#saveModal *[required]").keyup();
        });
        ...
        $(".item-setting-inactive").click(function (e) {
            ...
            PROJSTAT.MaintainData(CONST.transaction_type.statusUpdate, $("#u_id").val(), $("#u_code").val(), $("#u_description").val(),
        ...
        $(".item-setting-delete").click(function (e) {
            ...
            var confirmEvt = function () {
                ...
                PROJSTAT.MaintainData(CONST.transaction_type.statusUpdate, $("#u_id").val(), $("#u_code").val(), $("#u_description").val(), CONST.record_status.delete, _item_list);
            }
            Site.Dialogs.Confirm(["Remove ", $("#headerTitle").html()].join(''), ["Are you sure you want to remove selected ",
                $("#headerTitle").html(), "(s)?"].join(''), "Yes", "Cancel", confirmEvt, null);
        });
    ...
    MaintainData: function (process, id, code, proj_desc, status, item_list) {
        ...
        var param = {
            'id': id,
            'proj_statcode': code,
            'proj_statdescription': proj_desc,
            'status': status,
        };
