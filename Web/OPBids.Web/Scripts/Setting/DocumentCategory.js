...
var DC = {
    ...
    Initialize: function () {
        ...
        $(".toolbar-add").click(function (e) {
            ...
            DC.Status = CONST.record_status.activate;
        ...
        $(".toolbar-delete").click(function () {
            var confirmEvt = function () {
                ...
                DC.MaintainData(CONST.transaction_type.statusUpdate, 0, null, null, CONST.record_status.delete, _item_list);
            }
        ...
        $(".toolbar-search").click(function () {
            DC.MaintainData(CONST.transaction_type.search, $("#u_id").val(), $("#u_code").val(), $("#u_name").val(), DC.Status, null);
        });
        ...
        $("#btnSave").click(function () {
            if (Site.ValidateRequiredEntries("#saveModal", null) == true) {
                DC.MaintainData(CONST.transaction_type.save, $("#u_id").val(), $("#u_code").val(), $("#u_name").val(), DC.Status, null);
        ...
        $(".item-setting-edit").click(function (e) {
            ...
            DC.Status = $(["tr#row-" + _id, " td[status]"].join('')).attr("statusid").trim();
            $('#saveModal').modal('show');
            $("#saveModal *[required]").keyup();
        });
        ...
        $(".item-setting-inactive").click(function (e) {
            ...
            DC.MaintainData(CONST.transaction_type.statusUpdate, $("#u_id").val(), $("#u_code").val(), $("#u_name").val(),
        ...
        $(".item-setting-delete").click(function (e) {
            ...
            var confirmEvt = function () {
                ...
                DC.MaintainData(CONST.transaction_type.statusUpdate, $("#u_id").val(), $("#u_code").val(), $("#u_name").val(), CONST.record_status.delete, _item_list);
            }
            Site.Dialogs.Confirm(["Remove ", $("#headerTitle").html()].join(''), ["Are you sure you want to remove selected ",
                $("#headerTitle").html(), "(s)?"].join(''), "Yes", "Cancel", confirmEvt, null);
        });
    ...
    MaintainData: function (process, id, code, name, status, item_list) {
        var _result;
        var param = {
            'id': id,
